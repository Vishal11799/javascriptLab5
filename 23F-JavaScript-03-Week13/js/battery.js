...
function updateBatteryStatus(battery) {
    ...
    const imageUrl = `https://robohash.org/${batteryPercentage}?set=set2`;
    const imageElement = document.createElement('img');
    imageElement.src = imageUrl;
    imageElement.alt = `Robohash for ${batteryPercentage}%`;
    chargeLevel.innerHTML = `${batteryPercentage}% `;
    chargeLevel.appendChild(imageElement);
